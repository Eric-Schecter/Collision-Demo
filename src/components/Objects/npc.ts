import { Group, Scene, Vector3, TextureLoader, PlaneBufferGeometry, MeshBasicMaterial, Mesh, Vector2 } from "three";
...
export default class NPC {
  ...
  constructor(_pos: Pos2D, scene: Scene) {
    ...
    this.targetPos = new Vector2(x + 10, z + 10);
